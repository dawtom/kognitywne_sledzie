...
# amplitude = 1.5  # Amplitude of the waveform
# step_duration = 0.1  # Time (seconds) to play at each step
#
#
#
# def play(frequency):
...
#     print(frequency)
#     generator.play(frequency[0], step_duration, amplitude)
#     print("Played")
...
#         frequency_start *= 1.5
#
#     p = executor.submit(play, (frequency_start,))
#     time.sleep(0.05)
    # while(generator.is_playing()):
    #     pass
...
#                                 num_frequencies):
#
#     print("Playing tone at {0:0.2f} Hz, {1}, {2}".format(frequency, step_duration, amplitude))
#     generator.play(frequency, step_duration, amplitude)
#     while generator.is_playing():
#         pass  # Do something useful in here (e.g. recording)

# generator.play(700, step_duration, amplitude)
# while generator.is_playing():
#     pass